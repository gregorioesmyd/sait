...
class Perfil
{
    ...
    /**
     * @var boolean
     * @ORM\Column(name="bolsa_comida", type="boolean", nullable=true)
     */
    private $bolsaComida;
  ...
  /**
     ...
     * @return Perfil
     */
    public function setBolsaComida($bolsaComida)
    {
        $this->bolsaComida = $bolsaComida;
     ...
     * @return boolean 
     */
    public function getBolsaComida()
    {
        return $this->bolsaComida;
    }
     ...
     * Set jerarquia
     *
     * @param \Administracion\UsuarioBundle\Entity\Jerarquia $jerarquia
     * @return Perfil
     */
    public function setJerarquia(\Administracion\UsuarioBundle\Entity\Jerarquia $jerarquia = null)
    {
     ...
     * Get jerarquia
     *
     * @return \Administracion\UsuarioBundle\Entity\Jerarquia 
     */
