 ...
 * Visita
 *
 * @ORM\Table(name="controlequipo.visita")
 * @ORM\Entity
 */
class Visita
{
     ...
     * @ORM\SequenceGenerator(sequenceName="controlequipo.visita_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     * @return Visita
     */
    public function setUsuario(\Frontend\ControlEquipoBundle\Entity\Usuario $usuario = null)
    {
