 ...
 * SgtSatelite
 *
 * @ORM\Table(name="videoteca.sgt_deporte")
 * @ORM\Entity
 */
class SgtDeporte extends Segmento
{

    const CLASE = "SgtDeporte";
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Frontend\VideotecaBundle\Entity\Disciplina")
     ...
     * Set disciplina
     *
     * @param \Frontend\VideotecaBundle\Entity\Disciplina $disciplina
     * @return SgtDeporte
     */
    public function setDisciplina(\Frontend\VideotecaBundle\Entity\Disciplina $disciplina = null)
    {
     ...
     * Get disciplina
     *
     * @return \Frontend\VideotecaBundle\Entity\Disciplina 
     */
