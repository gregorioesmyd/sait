...
class DefaultController extends Controller
{
    ...
    public function procesatxt($fecha_escaleta,$tipo){
	        ...
	        $archivo = fopen ("/var/www/uploads/creatv/txt/".$fecha_escaleta."_".$tipo.".txt", "w+");

	        fwrite($archivo, $txt);
	        fclose($archivo);

	        SubirArchivo("/var/www/uploads/creatv/txt/".$fecha_escaleta."_".$tipo.".txt",$fecha_escaleta."_".$tipo.".txt");
