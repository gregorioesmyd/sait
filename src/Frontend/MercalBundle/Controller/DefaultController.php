...
class DefaultController extends Controller
{
    ...
    public function listadoAction($idjornada)
    {
        ...
        foreach ($usernumerotrab as $v) {
            $numeroasignadotrab[$v->getTrabajador()->getId()]=$v->getNumero();
        }  
        ...
        foreach ($usernumerofam as $v) {
            $numeroasignadofam[$v->getTrabajador()->getId()]=$v->getNumero();
        }  
    ...
    public function proximos($jornada){
        ...
        if(isset($json)){
            ...
            $fh = fopen("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY")."proximos.json", 'w+');
            fwrite($fh, $jsonencoded);
            fclose($fh);
            return;
        } else {
            if (file_exists("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY")."proximos.json")) {
                unlink("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY")."proximos.json");
            }
        }
    }
    ...
    public function actualizajson($jornada){
        ...
        $jsonencoded = json_encode($json);
        $fh = fopen("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY").".json", 'w+');
        fwrite($fh, $jsonencoded);
        fclose($fh);
        return;
    }
    ...
    public function indexAction($idjornada)
    {
        ...
        if (file_exists("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY").".json")) {
            $str_datos = file_get_contents("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY").".json");
    ...
    public function homepagenumAction($idjornada)
    {
        ...
        if (file_exists("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY")."proximos.json")) {
            $proximos = file_get_contents("/var/www/uploads/jornada/".$jornada->getNombrejornada().$jornada->getFechajornada()->format("dmY")."proximos.json");
    ...
    public function numeracionAction($idjornada1,$idjornada2)
    {
        ...
        if (file_exists("/var/www/uploads/jornada/".$jornada1->getNombrejornada().$jornada1->getFechajornada()->format("dmY").".json")) {
            $str_datos = file_get_contents("/var/www/uploads/jornada/".$jornada1->getNombrejornada().$jornada1->getFechajornada()->format("dmY").".json");
            $datos = json_decode($str_datos,true);
            $datos1=$datos[0];

        } 
        if (file_exists("/var/www/uploads/jornada/".$jornada2->getNombrejornada().$jornada2->getFechajornada()->format("dmY").".json")) {
            $str_datos = file_get_contents("/var/www/uploads/jornada/".$jornada2->getNombrejornada().$jornada2->getFechajornada()->format("dmY").".json");
            $datos = json_decode($str_datos,true);
            $datos2=$datos[0];
