...
class TicketController extends Controller
{
    ...
    public function filtrarsolicitud($solicitud){
        ...
        $eliminar=array(
            "hola","muchas gracias","Joan","Urgente,","Buenos días","buenos dias,","buenos dias","buenos días,","buenos días","buen día","buenas tardes,","buenas tardes","saludos","chicos:",
    ...
    public function guardacatsubAction(Request $request,$id)
    {
        ...
        $this->get('session')->getFlashBag()->add('notice', 'Categoria asignada exitosamente');
        return $this->redirect($this->generateUrl('ticket_show', array('id' => $id)));      
