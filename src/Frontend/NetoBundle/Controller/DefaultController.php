...
class DefaultController extends Controller
{
    public function indexAction()
    {
       ...
       // $tipnom=array('s'=>'Seleccione', 'n'=>'Nómina');
            ...
            if($anio==date('Y'))
                ...
                if($mes==date('n'))
                    ...
                    if($quincena==1){
                        ...
                        $diasemana=date("w", mktime(0, 0, 0, $mes, 15, $anio));

                        //dia de la semana
                        //if($diasemana==0)$diaactivacion=15;
                        //else if($diasemana==1)$diaactivacion=15;
                        //else if($diasemana==6)$diaactivacion=15;
                        //else 
                        $diaactivacion=15;
                        ...
                        if($ultimodia==31 or $ultimodia==30)$ultimodia=30;
