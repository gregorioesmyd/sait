...
namespace Frontend\ConstanciaBundle\Entity;
 ...
 * Ciudad
 *
 * @ORM\Table(name="constancia.constancia")
 * @ORM\Entity
 */
class Constancia
{
     ...
     * @ORM\SequenceGenerator(sequenceName="constancia.constancia_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
